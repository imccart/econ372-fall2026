...
Most of this course is assessed **in class**, so there is little to turn in outside of the empirical homework.
  ...
  - **Empirical homework** is submitted as a **rendered notebook** (Quarto or Jupyter) on Canvas --- a single document containing your code, its output, your written answers, and a short verification note (see [AI and assignments](#ai-and-assignments)). Please make sure the rendered file is legible and well organized; misaligned or unreadable submissions will be treated as late until corrected.
